...
namespace DAL.queries
{
    public abstract class UsuarioQuery
    {
        ...
        public const string Insertar = @"INSERT INTO Usuario (dni, apellido, nombre, usuario, pass, rol_id, email)
                                 VALUES (@Dni, @Apellido, @Nombre, @Usuario, @Pass, @RolId, @Email)";
        ...
        public const string ModificarUsuario = @"UPDATE Usuario set bloqueo = @Bloqueo,
